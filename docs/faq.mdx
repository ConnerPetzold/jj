...
To view the elided revisions, change the [revset expression](./reference/revsets.mdx) so it
...
### Should I colocate my repository?
...
drawbacks](./comparisons/git-compatibility.mdx#colocated-jujutsugit-repos) but the most
important ones are:
...
- If the working copy commit or its parent contain any conflicted files, tools
  ...
  conflicts](./technical-details/conflicts.mdx)). See
...
[git.private-commits](./reference/config.mdx#set-of-private-commits):
...
[glossary_divergence]: /concepts/glossary#divergent-change
...
See: [Handling divergent commits](./guides/divergence.mdx).
...
[bookmarks_conflicts]: /concepts/bookmarks#conflicts
[change]: /concepts/glossary#change
[change ID]: /concepts/glossary#change-id
[colocated]: /concepts/glossary#colocated-repos
[commit ID]: /concepts/glossary#commit-id
[commits]: /concepts/glossary#commit
[config]: /reference/config
[gerrit-integration]: https://gist.github.com/thoughtpolice/8f2fd36ae17cd11b8e7bd93a70e31ad6
[gitignore]: https://git-scm.com/docs/gitignore
[operator]: /reference/revsets#operators
[revsets]: /reference/revsets
