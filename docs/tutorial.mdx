---
title: Tutorial
description: A bird's eye view
icon: BookOpen
---

This tutorial will walk you through the basics of Jujutsu. It assumes that you are familiar with Git.

## Clone the repository

Let's start by cloning GitHub's Hello-World repo using `jj`. Note the "git" before "clone" (there is no support for cloning native jj repos yet).

```ansi
[0;32;1m$[0m [0;34mjj [0;36mgit clone https://github.com/octocat/Hello-World[0m[0m
Fetching into new repo in "/tmp/Hello-World"[0m
remote: Enumerating objects: 13, done.[0m
remote: Total 13 (delta 0), reused 0 (delta 0), pack-reused 13 (from 1)[0m
bookmark: [0;35mmaster@origin         [0m [new] tracked[0m
bookmark: [0;35moctocat-patch-1@origin[0m [new] untracked[0m
bookmark: [0;35mtest@origin           [0m [new] untracked[0m
Setting the revset alias `trunk()` to `master@origin`[0m
Working copy  (@) now at: [0;95;1mk[0;90;1mmkoyqpv[0;1m [0;94;1m6[0;90;1md789ec0[0;1m [0;92;1m(empty)[0;1m [0;92;1m(no description set)[0m[0m
Parent commit (@-)      : [0;35;1mo[0;90mrrkosyo[0m [0;34;1m7[0;90mfd1a60b[0m [0;35mmaster[0;90m | [0;32m(empty)[0m Merge pull request #6 from Spaceghost/patch-1[0m
Added 1 files, modified 0 files, removed 0 files[0m

[0;32;1m$[0m [0;34mcd [0;36mHello-World[0m[0m
```

> **Hint:** Most identifiers used in this tutorial will be different when you try this at
> home!
...
```ansi
[0;32;1m$[0m [0;34mjj [0;36mst[0m[0m
The working copy has no changes.[0m
Working copy  (@) : [0;95;1mk[0;90;1mmkoyqpv[0;1m [0;94;1m6[0;90;1md789ec0[0;1m [0;92;1m(empty)[0;1m [0;92;1m(no description set)[0m[0m
Parent commit (@-): [0;35;1mo[0;90mrrkosyo[0m [0;34;1m7[0;90mfd1a60b[0m [0;35mmaster[0;90m | [0;32m(empty)[0m Merge pull request #6 from Spaceghost/patch-1[0m
```
...
The parent commit, for example, has the change ID `[0;35;1mo[0;90mrrkosyo[0m{:ansi}` and the commit ID
`[0;34;1m7[0;90mfd1a60b[0m{:ansi}`.

> **Hint:** The commit ID/hash is what you're used to from Git and should match what you
> see when you look at the repository using `git log` in a Git checkout of the
> repository. The change ID however, is a new concept, unique to Jujutsu.

We can also see from the output above that our working copy is an actual commit
with a commit ID (`[0;94;1m6[0;90;1md789ec0[0;1m{:ansi}` in the example). When you make a change in the
working copy, the working-copy commit gets automatically amended by the next
`jj` command.

> **Hint:** This is a huge difference from Git where the working copy is a separate
> concept and not yet a commit.
...
This new change has the ID `[0;95;1mk[0;90;1mmkoyqpv[0;1m{:ansi}` and it is currently empty (contains no
changes compared to the parent) and has no description.

## Create our first change
...
we don't forget what we're working on. `jj describe` brings up `$EDITOR` (or `pico` or `Notepad` by default).

Enter something like "Say goodbye" in the editor and then save the file and close the editor.

```ansi
[0;32;1m$[0m [0;34mjj [0;36mdescribe[0m[0m
Working copy  (@) now at: [0;95;1mk[0;90;1mmkoyqpv[0;1m [0;94;1mc[0;90;1m2141ca4[0;1m [0;92;1m(empty)[0;1m Say goodbye[0m[0m
Parent commit (@-)      : [0;35;1mo[0;90mrrkosyo[0m [0;34;1m7[0;90mfd1a60b[0m [0;35mmaster[0;90m | [0;32m(empty)[0m Merge pull request #6 from Spaceghost/patch-1[0m
```
...
```ansi
[0;32;1m$[0m [0;34msed [0;36m-i [0;33m's/Hello/Goodbye/'[0;36m [0;36;4mREADME[0m
[0;32;1m$[0m [0;34mjj [0;36mst[0m[0m
Working copy changes:[0m
[0;36mM README[0m[0m
Working copy  (@) : [0;95;1mk[0;90;1mmkoyqpv[0;1m [0;94;1m9[0;90;1m69add2a[0;1m Say goodbye[0m[0m
Parent commit (@-): [0;35;1mo[0;90mrrkosyo[0m [0;34;1m7[0;90mfd1a60b[0m [0;35mmaster[0;90m | [0;32m(empty)[0m Merge pull request #6 from Spaceghost/patch-1[0m
```
...
Also note that the commit hash for our current change (`[0;95;1mk[0;90;1mmkoyqpv[0;1m{:ansi}`) changed from
`[0;94;1mc[0;90;1m2141ca4[0;1m{:ansi}` to `[0;94;1m9[0;90;1m69add2a[0;1m{:ansi}`!

To see the diff, run `jj diff`:

```ansi
[0;32;1m$[0m [0;34mjj [0;36mdiff[0m[0m
[0;33mModified regular file README:[0m[0m
[0;31m   1[0m [0;32m   1[0m: [0;31;4mHello[0;32;4mGoodbye[0m World![0m
```
...
```ansi
[0;32;1m$[0m [0;34mjj [0;36mnew[0m[0m
Working copy  (@) now at: [0;95;1mkz[0;90;1mssknrp[0;1m [0;94;1me[0;90;1m1856755[0;1m [0;92;1m(empty)[0;1m [0;92;1m(no description set)[0m[0m
Parent commit (@-)      : [0;35;1mkm[0;90mkoyqpv[0m [0;34;1m9[0;90m69add2a[0m Say goodbye[0m
[0;32;1m$[0m [0;34mjj [0;36mst[0m[0m
The working copy has no changes.[0m
Working copy  (@) : [0;95;1mkz[0;90;1mssknrp[0;1m [0;94;1me[0;90;1m1856755[0;1m [0;92;1m(empty)[0;1m [0;92;1m(no description set)[0m[0m
Parent commit (@-): [0;35;1mkm[0;90mkoyqpv[0m [0;34;1m9[0;90m69add2a[0m Say goodbye[0m
```
