...
<div className="flex justify-center">
  <figure className="w-[320px]">![jj logo](/images/jj-logo.svg)</figure>
</div>
...
- [Installation and setup](./getting-started/install-and-setup.mdx)
- [Tutorial and bird's eye view](./getting-started/tutorial.mdx)
- [Working with GitHub](./getting-started/github.mdx)
- [Development roadmap](./roadmap.mdx)
