...
<Callout title="Which completion script should I use?">
...
<Tabs groupId="language" items={['Standard', 'Dynamic']}>
<Tab value="Standard">
```shell
...
<Callout>
  No configuration is required with fish >= 4.0.2 which loads dynamic
...
<Tabs groupId="language" items={['Standard']}>
<Tab value="Standard">
