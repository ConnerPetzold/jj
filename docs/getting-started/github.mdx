...
[colocates](/comparisons/git-compatibility#colocated-jujutsugit-repos) the `.jj` and
...
The hyphen after `your-feature` comes from the [revset](/reference/revsets) syntax.
...
that aren't [colocated](/comparisons/git-compatibility#colocated-jujutsugit-repos)
...
[auto-bookmark]: /reference/config#automatic-local-bookmark-creation
...
[tut]: /getting-started/tutorial#conflicts
