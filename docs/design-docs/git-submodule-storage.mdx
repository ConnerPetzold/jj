...
The decision will be recorded in [/git-submodules](/design-docs/git-submodules).

## Use cases to consider

The submodule storage format should support the workflows specified in the
[submodules roadmap](/design-docs/git-submodules). It should be obvious how "Phase 1"
