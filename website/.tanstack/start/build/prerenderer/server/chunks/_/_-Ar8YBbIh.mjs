...
import { notFound, createFileRoute } from 'file:///Users/conner/jj/website/node_modules/@tanstack/react-router/dist/esm/index.js';
import { D as DocsLayout, b as baseOptions } from './layout.shared-JiWhm5gR.mjs';
import { Y as createServerRpc, Z as createServerFn, _ as source, d as docs, D as DocsPage, a as DocsTitle, b as DocsDescription, c as DocsBody, e as defaultMdxComponents } from './ssr.mjs';
...
const Route = createFileRoute("/_docs/$")({
  loader: async ({
    ...
    const data = await loader({
      data: (_b = (_a = params._splat) == null ? void 0 : _a.split("/")) != null ? _b : []
    });
  ...
  head: ({
    ...
    meta: [{
      title: (loaderData == null ? void 0 : loaderData.title) ? `${loaderData.title} | Jujutsu` : "Jujutsu"
    }]
  }),
  component: Page
});
...
//# sourceMappingURL=_-Ar8YBbIh.mjs.map
