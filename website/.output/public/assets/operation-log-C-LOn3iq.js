import{j as e}from"./main-BYx1FFWF.js";let a={title:"Operation log"},r=[],s={contents:[{heading:"introduction",content:`Jujutsu records each operation that modifies the repo in the "operation log".
