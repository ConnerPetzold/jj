import{j as n}from"./main-BYx1FFWF.js";let i={title:"Core tenets"},a=[],r={contents:[{heading:void 0,content:`Separation of logic and UI: It should be as easy to create new UIs (CLIs,
