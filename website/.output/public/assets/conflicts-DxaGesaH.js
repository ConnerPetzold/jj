import{j as e}from"./main-BCYT0j2h.js";let s={title:"Conflicts"},a=[{href:"/concepts/concurrency"},{href:"../git-compatibility#format-mapping-details"}],c={contents:[{heading:"introduction",content:`Conflicts can happen when two changes are applied to some state. This document
