...
<Callout>
  Most identifiers used in this tutorial will be different when you try this at
  home!
</Callout>
...
<Callout>
  The commit ID/hash is what you're used to from Git and should match what you
...
<Callout>
  This is a huge difference from Git where the working copy is a separate
