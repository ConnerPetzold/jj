...
description: We'd love to accept your patches and contributions to this project. There are
---
...
website](https://jj-vcs.github.io/jj/prerelease) or in the `jj help <command>` docs.
...
excellent resources at [https://www.rust-lang.org/learn](https://www.rust-lang.org/learn), we recommend the
...
[https://jj-vcs.github.io/jj/](https://jj-vcs.github.io/jj/).
...
Open [http://127.0.0.1:8000](http://127.0.0.1:8000) in your browser to see the docs.
...
URL [https://jj-vcs.github.io/jj](https://jj-vcs.github.io/jj) redirects to
[https://jj-vcs.github.io/jj/latest](https://jj-vcs.github.io/jj/latest), which in turn redirects to
...
[https://jj-vcs.github.com/jj](https://jj-vcs.github.com/jj) (instead of the usual `main` bookmark).
...
from [https://jj-vcs.github.com/jj](https://jj-vcs.github.com/jj) and something fails weirdly, you might want
